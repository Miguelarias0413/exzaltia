...
@section('contenido')
    ...
    <div class=" w-screen h-screen py-6">
        <h2 class=" text-white text-center font-extrabold text-2xl md:text-3xl uppercase mb-6">
            Nuestros productos
        ...
        <div class="w-60 md:w-72 bg-slate-400 bg-opacity-50 border border-2-stone-900 rounded-xl shadow backdrop-blur-sm ">
            <a href="" class=" ">
                <img class=" p-3 rounded-t-lg aspect-square rounded-3xl "
                    src="{{Storage::url($clothing_items->gallery->front_image) }}" alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
